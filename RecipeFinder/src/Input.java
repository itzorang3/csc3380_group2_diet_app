...
public class Input {
    ...
    private Scanner scanner; //declaring variable scanner from Scanner class. Like empty placeholder and
...
//userinput into the variable scanner. 
    ...
    public String getIngredients() {
        ...
        return scanner.nextLine(); //returns the user's ingredients
